...
class ArticleViewSet(viewsets.ReadOnlyModelViewSet):
	queryset = Article.objects.prefetch_related('summaries').order_by('rank')
...
class RefreshView(APIView):
	...
	def post(self, request):
		...
		return Response({'created': results.created, 'updated': results.updated, 'summarized': results.summarized})
